...
#Begin clock constraint
define_clock -name {demo|rd_spi_derived_clock[0]} {n:demo|rd_spi_derived_clock[0]} -period 10.000 -clockgroup Autoconstr_clkgroup_0 -rise 0.000 -fall 5.000 -route 0.000 
#End clock constraint
